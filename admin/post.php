    ...
    <div id="content" class="jumbotron">
        <div class="container-fluid">
                ...
                <div class="card">
                  <div class="card-body">
                    <h3>All post</h3>
                    <a href="post_add.php" class="btn btn-success text-white float-right">Add</a>
    ...
    ?>
                        <tr scope="">
                          ...
                          <td>
                            ...
                            <a onclick="return confirm('Are You Sure?')" href="delete_post.php?id=<?php echo $menudata['post_id'];?>&smid=<?php echo $menudata['submenu_id'];?>&mid=<?php echo $menudata['menu_id'];?>"><i class="fa fa-trash" aria-hidden="true"></i></a>

                            <a href="update_post.php?id=<?php echo $menudata['post_id'];?>"><i class="fa fa-edit"></i></a>
...
if ($pagi_result) {
  ...
  $page_total = ceil($rec_total/$pagi_limit);
     ...
     if ($page_numbar> 1) {
       echo'<li><a class="page-link" href="post.php?page='.($page_numbar-1).'">Prev</a></li>';
     }
   ...
   if ($page_total> $page_numbar) {
       echo'<li><a class="page-link" href="post.php?page='.($page_numbar+1).'">Next</a></li>';
     }
  echo"</ul>";
 }
?> 
